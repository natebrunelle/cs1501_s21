...
remote=njb2b@portal.cs.virginia.edu:public_html/cs1501/s21
...
if [ "$#" -lt 1 ] || [ "$1" != 'test' ]
then
    git commit -a -m 'autocommit caused by update, changes not live.'
    git pull
    git push
elif [ "$1" = 'test' ]
then
...
function upfile_inner() {
    ...
    then
        ...
        $pd --standalone \
            ...
            --number-sections \
            --title-prefix="Understanding Computer Science" \
...
then
    echo "doing schedule"
    python3 cal2html.py
    #scp "assignments.json" "kytos:/var/www/html/cs1501-s21/meta/"
    #scp "coursegrade.json" "kytos:/var/www/html/cs1501-s21/meta/"
fi
